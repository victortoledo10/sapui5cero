		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "cero",
									"targetURL": "#esvictorcero-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"esvictorcero-display": {
								"semanticObject": "esvictorcero",
								"action": "display",
								"description": "cero",
								"title": "cero",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=es.victor.cero",
									"url": sap.ui.require.toUrl("es/victor/cero")
								}
							}
						}
					}
